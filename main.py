...
def main():
    ...
    _plot_question_one(neighbourhoods, room_types, messi_color_palette)
    _plot_question_two_and_three(neighbourhoods, room_types, 'price', 'Price by Room Type by Neighbourhood', ['#f79256', '#a53860','#1d4e89', '#4c3b4d'])
    _plot_question_two_and_three(neighbourhoods, room_types, 'rating', 'Rating by Room Type by Neighbourhood',['#f79256', '#a53860','#1d4e89', '#4c3b4d'])
...
def _plot_question_one(neighbourhoods: List[str], room_types: List[str], color_list: List[str]):
    """
...
def _plot_question_two_and_three(neighbourhoods: List[str], room_types: List[str], y: str, title: str, color_list: List[str]):
    sns.set()
